...
for i, row in df.iterrows():
    ...
    # Read and encode the contents of the deflate file in base64
    with open(deflate_filename, 'rb') as deflate_file:
        deflate_content_base64 = base64.b64encode(deflate_file.read()).decode()

    # Decompression test on the base64 encoded string
    deflate_content = base64.b64decode(deflate_content_base64)
    ...
    new_dataset.append({'text': truncated_review, 'deflate_base64': deflate_content_base64})
...
os.removedirs(text_dir)
os.removedirs(deflate_dir)
